...
function HeroSection() {
  ...
  return (
    <>
      <div className="h-[45rem] overflow-hidden w-full relative flex items-center justify-center">
        <Spotlight />
        <div className="max-w-5xl mx-auto p-4">
          ...
          <div className="text-neutral-700 text-center text-xs md:text-sm mt-2">
            <TextGenerateEffect
